...
class _$_ProductModel with DiagnosticableTreeMixin implements _ProductModel {
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'ProductModel(id: $id, namevi: $namevi, descvi: $descvi, regular_price: $regular_price, sale_price: $sale_price, discount: $discount, id_list: $id_list, photo: $photo, isFavourite: $isFavourite)';
  }
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties
      ...
      ..add(DiagnosticsProperty('descvi', descvi))
      ..add(DiagnosticsProperty('regular_price', regular_price))
      ..add(DiagnosticsProperty('sale_price', sale_price))
      ..add(DiagnosticsProperty('discount', discount))
      ..add(DiagnosticsProperty('id_list', id_list))
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, id, namevi, descvi,
      regular_price, sale_price, discount, id_list, photo, isFavourite);
